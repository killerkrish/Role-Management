...
<body>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="add-computer.php">Product Details</a></li>
    ...
    echo $msg;
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">Product Name</label><input type="text" name="compname" value="" class="form-control" id="compname" required="true"></div>
                                                                          
                                        <div class="form-group"><label for="street" class=" form-control-label">Product Brand</label><input type="text" name="comploc" value="" id="comploc" class="form-control" required="true"></div>
                                            <div class="row form-group">
                                                <div class="col-12">
                                                    <div class="form-group"><label for="city" class=" form-control-label">Product Price</label><input type="text" name="idadd" id="idadd" value="" class="form-control" required="true"></div>
                                                    </div>
