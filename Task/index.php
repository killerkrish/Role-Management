...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID, RoleId from tbladmin where  UserName='$adminuser' && Password='$password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['ccmsaid']=$ret['ID'];
      $_SESSION['roleid']=$ret['RoleId'];
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h3 style="color: white">Role Management</h3>
                    <hr  color="red"/>
                </div>
