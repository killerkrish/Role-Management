...
<li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-file-o"></i><a href="add-computer.php">Add Product</a></li>
                            <li><i class="menu-icon fa fa-file-o"></i><a href="manage-computer.php">Manage Products</a></li>
                        </ul>
                    </li>
<li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-file-o"></i><a href="add-roles.php">Add Roles</a></li>
                            <li><i class="menu-icon fa fa-file-o"></i><a href="manage-roles.php">Manage Roles</a></li>
                        </ul>
                    </li>
 <li class="menu-item-has-children dropdown">
